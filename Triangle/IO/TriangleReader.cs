...
namespace TriangleNet.IO
{
    ...
    public class TriangleReader
    {
        ...
        //获取文件内点的个数、点位维度、属性字段数、边界表示个数（0或1）
        ...
        public Polygon ReadNodeFile(string nodefilename, bool readElements)
        {
            ...
            using (var reader = new StreamReader(nodefilename))
            {
                ...
                // Read number of vertices, number of dimensions, number of vertex attributes, and number of boundary markers.
